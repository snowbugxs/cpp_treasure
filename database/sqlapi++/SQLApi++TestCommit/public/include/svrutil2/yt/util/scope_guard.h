...
#define AC_ON_BLOCK_EXIT(...)      ::yt::ScopeGuard AC_ANONYMOUS_VARIABLE(scopeGuard) = ::yt::MakeGuard(__VA_ARGS__); ((void)AC_ANONYMOUS_VARIABLE(scopeGuard))
#define AC_ON_BLOCK_EXIT_OBJ(...)  ::yt::ScopeGuard AC_ANONYMOUS_VARIABLE(scopeGuard) = ::yt::MakeObjGuard(__VA_ARGS__); ((void)AC_ANONYMOUS_VARIABLE(scopeGuard))
