...
#define F_VSMESS 158
#define F_VSVARSTR0 159
#define F_VSVARSTR1 160
#define F_VSVARSTR2 161
#define F_VSVARSTR3 162
#define F_VSVARSTR4 163
#define F_VSVARSTR5 164
#define F_VSVARSTR6 165
/* 以下代码是用来字节对齐使用的 */
#ifdef WIN32
  #define __PACKED__
   #pragma pack(push,1)
...
char vsmess[256];   //158. 信息
char vsvarstr0[256];   //159.变长的字符串
char vsvarstr1[256];   //160.变长的字符串
char vsvarstr2[256];   //161.变长的字符串
char vsvarstr3[256];   //162.变长的字符串
char vsvarstr4[512];   //163.变长的字符串
char vsvarstr5[512];   //164.变长的字符串
char vsvarstr6[1024];   //165.变长的字符串
} __PACKED__ ST_PACK;
